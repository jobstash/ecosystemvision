...
const granteeProject = fakeGranteeProject();
grantee.projects.push(granteeProject);
const projectId = granteeProject.id;
...
const meta: Meta<typeof Component> = {
  ...
  parameters: {
    nextjs: {
      navigation: {
        pathname: `/${ROUTE_SECTIONS.IMPACT}/${grantId}/grantees/${granteeId}/projects/${projectId}`,
        segments: [
          ['grantId', grantId],
          ['granteeId', granteeId],
          ['projectId', projectId],
