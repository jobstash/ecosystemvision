...
export const HomePage = () => {
  return (
    <div className="overflow-hidden font-inter lg:pt-0">
      <AppHeaderProvider>
        <AppHeader
      ...
      <ActiveSearchHiddenWrapper>
        <main className="relative mt-[122px] max-w-[1340px] px-5 pt-12 text-white md:px-10 lg:px-7 lg:pt-20">
          ...
          <section className="pb-20 pt-28 md:pb-32 lg:flex lg:flex-wrap lg:items-start lg:pt-40">
            ...
            <div className="lg:w-2/3 lg:px-14">
              ...
              <p className="pb-12 text-base leading-5 lg:text-xl lg:leading-tight">
                ...
                representatives can connect, collaborate, and drive innovation
                in the Web3 space. Stay tuned for more details and be among the
                first to join.
              </p>
              <Button
                as={Link}
          ...
          <section className="relative">
            ...
            <div className="lg:lefft-0 lg:absolute lg:top-0 lg:w-1/3 lg:translate-y-1/2">
              ...
              <p className="pb-12 text-base leading-5 lg:text-xl lg:leading-tight">
                ...
                capital funds in the Web3 space. VCs can sign up now to gain
